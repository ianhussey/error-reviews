...
data_publications <- 
  ...
  mutate(citations_per_year = round_half_up(citation_count / (pubyear_search_end-1 - year_for_citations_by_year), 2),
         more_than_30_citations_per_year = citations_per_year >= 30)

# write to disk
write_csv(data_publications, "../data/articles/data_publications_scopus.csv")
