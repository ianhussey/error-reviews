...
get_mode(data_processed$citations)
...
median(data_processed$citations)
...
percentiles |>
  filter(citations != lead(citations) | is.na(lead(citations))) |>
...
ggsave("plots/citations_percentiles.png", width = 10, height = 4)
